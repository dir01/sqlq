...
func (tc *TestCase) TestBasicPubSub(ctx context.Context, t *testing.T) {
	...
	// Consume the queue
	err := tc.Q.Consume(ctx, "test_job", func(_ context.Context, _ *sql.Tx, payloadBytes []byte) error { // Rename unused ctx to _
...
func (tc *TestCase) TestBasicPubMultiSub(ctx context.Context, t *testing.T) {
	...
	err := tc.Q.Consume(ctx, "shared_job", func(_ context.Context, _ *sql.Tx, _ []byte) error {
